...
class ChefList extends StatefulWidget {
  const ChefList({Key? key}) : super(key: key);

  @override
  State<ChefList> createState() => _ChefListState();
}

class _ChefListState extends State<ChefList> with TickerProviderStateMixin {
          ...
          Padding(
            ...
            child: Row(
              children: const [
                Expanded(
                  child: Text(
                    "voici les chefs d'agences de votre application.",
                    style: TextStyle(
